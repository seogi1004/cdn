...
*   **종합 평점 공식**: `종합 평점 = (자산보존성 × 0.40) + (학세권 × 0.35) + (사주/풍수 × 0.25) − 연식 감가 압력(agePress) × 10` (실거래 가중 헤도닉 모형 응용)
...
*   **세무 리스크 및 청약/매매 보정**:
    *   *웰카운티*: 현실적인 소액 프리미엄(P 5천~1억) 거래 시 66% 단기양도세 대납 요구로 실투자금이 급증하므로 `15점` 감점(최종 78점), 무피/급매 전매 시에는 세무 리스크가 소멸되어 `92점`으로 평가됩니다.
