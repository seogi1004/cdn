...
2. **인천 신검단**: 인천 1호선 연장역 초역세권과 서울 5호선 연장, GTX-D 중앙역 환승 벨트가 대기 중인 개발 도상지로 미래 가치 상승 동력이 더욱 큽니다. 특히 힐스테이트 비과세 완성 매입이나 더샵 분상제 청약을 통해 **거품이 완전히 제거된 안전한 원가(Margin of Safety)**에 진입할 수 있어 자산 수호에 압도적으로 유리합니다.
...
*   **연식에 따른 신축/구축 감가 방향성 (2027년 여름 계약 시점 기준)**:
    *   *더샵 22BL / 23BL / 웰카운티 / 힐스테이트*: 신축 프리미엄이 적용되어 연식 감가가 반영되지 않습니다.
...
*   **세무 리스크 및 청약/매매 보정 기준**:
    ...
    *   *더샵 22BL / 23BL*: 분상제 청약 단지로 세무 리스크가 없으나 22BL이 1호선 초역세권 입지로 우위입니다. 당첨된 동·층의 조망권(호수공원 정면 뷰 여부) 및 로열층(15층 이상) 여부에 따라 `최대 ±5점` 내외의 개별 동·층 보정 점수가 가산 또는 감산 적용됩니다.
