...
아버님의 현 전세 보증금 **5억 6,000만 원**과 임대인(집주인)의 구체적인 상황을 바탕으로, 계약갱신요구권 행사 시나리오와 실거주 거절 리스크를 정밀 시뮬레이션합니다.
...
*   **배상금액 산출 공식 (법정 손해배상액 중 가장 큰 금액 적용):**
    1.  **3개월분 월세 환산액:** 보증금 5억 6,000만 원을 법정 전월세전환율(2026년 기준 5.5% 가정)을 적용해 월세로 환산한 금액의 3개월분.
        *   *연 환산액:* $56,000 \times 5.5\% = 3,080$만 원
        *   *월 환산액:* $3,080 / 12 = 256.6$만 원
        *   **3개월분 배상금액:** $256.6 \times 3 = \mathbf{770}$**만 원**
    2.  **임대차 금액 차액의 2년분:** 임대인이 새로운 임차인에게 올려 받은 임대료 차액의 2년분. (예: 5.6억에서 6.6억으로 올렸다면 차액 1억에 대한 월세 전환금의 2년 치)
